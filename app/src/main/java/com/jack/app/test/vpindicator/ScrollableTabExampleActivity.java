...
import com.jack.widget.vpindicator.navigator.commonavi.indicators.BezierPagerIndicator;
import com.jack.widget.vpindicator.navigator.commonavi.indicators.LinePagerIndicator;
import com.jack.widget.vpindicator.navigator.commonavi.indicators.TriangularPagerIndicator;
import com.jack.widget.vpindicator.navigator.commonavi.indicators.WrapPagerIndicator;
import com.jack.widget.vpindicator.navigator.commonavi.title.ClipPagerTitleView;
import com.jack.widget.vpindicator.navigator.commonavi.title.ColorFlipPagerTitleView;
...
public class ScrollableTabExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vp_indicator_activity_scrollable_indicator_example_layout);
    ...
    private void initMagicIndicator1() {
        ...
        int padding = DisplayUtils.getScreenWidth(this) / 2;
    ...
    private void initMagicIndicator7() {
        ...
        commonNavigator7.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                LinePagerIndicator indicator = new LinePagerIndicator(context);
                indicator.setMode(LinePagerIndicator.MODE_EXACTLY);
                indicator.setLineHeight(DisplayUtils.dp2px(context, 6));
                indicator.setLineWidth(DisplayUtils.dp2px(context, 10));
