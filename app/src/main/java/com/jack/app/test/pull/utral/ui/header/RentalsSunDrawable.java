package com.jack.app.test.pull.utral.ui.header;
...
public class RentalsSunDrawable extends Drawable implements Animatable {
    ...
    private void initiateDimens() {
        ...
        mTotalDragDistance = DisplayUtils.dp2px(getContext(), 120);

        mScreenWidth = getContext().getResources().getDisplayMetrics().widthPixels;
        mSkyHeight = (int) (SKY_RATIO * mScreenWidth);
        mSkyTopOffset = -(mSkyHeight * 0.28f);
        mSkyMoveOffset = DisplayUtils.dp2px(getContext(), 15);
        ...
        mTownMoveOffset = DisplayUtils.dp2px(getContext(), 10);
    ...
    private void createBitmaps() {
        mSky = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.pull_utral_demo_sky);
        mSky = Bitmap.createScaledBitmap(mSky, mScreenWidth, mSkyHeight, true);
        mTown = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.pull_utral_buildings);
        mTown = Bitmap.createScaledBitmap(mTown, mScreenWidth, (int) (mScreenWidth * TOWN_RATIO), true);
        mSun = BitmapFactory.decodeResource(getContext().getResources(), R.drawable.pull_utral_sun);
