...
import com.jack.widget.vpindicator.navigator.commonavi.title.CommonPagerTitleView;
...
public class LoadCustomLayoutExampleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.vp_indicator_activity_load_custom_layout_example);
    ...
    private void initMagicIndicator1() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                // load custom layout
                View customLayout = LayoutInflater.from(context).inflate(R.layout.vp_indicator_simple_pager_title_layout, null);
                final ImageView titleImg = (ImageView) customLayout.findViewById(R.id.title_img);
                final TextView titleText = (TextView) customLayout.findViewById(R.id.title_text);
                titleImg.setImageResource(R.drawable.launcher);
