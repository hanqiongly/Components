...
import com.jack.app.test.viewpager.adapter.CircleViewPagerAdapter;
...
/**
 * Created by liuyang on 2018/5/28.
 */
...
public class CircleViewPagerActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mAdapter = new CircleViewPagerAdapter(imgRes);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        String[] effects = getResources().getStringArray(R.array.magic_effect);
