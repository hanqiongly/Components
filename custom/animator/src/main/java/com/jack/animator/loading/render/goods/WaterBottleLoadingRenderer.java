...
public class WaterBottleLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mBottleWidth = DisplayUtils.dp2px(context, DEFAULT_BOTTLE_WIDTH);
        mBottleHeight = DisplayUtils.dp2px(context, DEFAULT_BOTTLE_HEIGHT);
        mWaterLowestPointToBottleneckDistance = DisplayUtils.dp2px(context, WATER_LOWEST_POINT_TO_BOTTLENECK_DISTANCE);
