...
public class FishLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mRiverBankWidth = DisplayUtils.dp2px(context, DEFAULT_RIVER_BANK_WIDTH);

        mPathFullLineSize = DisplayUtils.dp2px(context, DEFAULT_PATH_FULL_LINE_SIZE);
        mPathDottedLineSize = DisplayUtils.dp2px(context, DEFAULT_PATH_DOTTED_LINE_SIZE);
        mFishWidth = DisplayUtils.dp2px(context, DEFAULT_FISH_WIDTH);
        mFishHeight = DisplayUtils.dp2px(context, DEFAULT_FISH_HEIGHT);
        mFishEyeSize = DisplayUtils.dp2px(context, DEFAULT_FISH_EYE_SIZE);
        mRiverWidth = DisplayUtils.dp2px(context, DEFAULT_RIVER_WIDTH);
        mRiverHeight = DisplayUtils.dp2px(context, DEFAULT_RIVER_HEIGHT);
