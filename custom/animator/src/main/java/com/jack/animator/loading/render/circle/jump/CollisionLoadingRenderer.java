package com.jack.animator.loading.render.circle.jump;
...
public class CollisionLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mBallRadius = DisplayUtils.dp2px(context, DEFAULT_BALL_RADIUS);
        mWidth = DisplayUtils.dp2px(context, DEFAULT_WIDTH);
        mHeight = DisplayUtils.dp2px(context, DEFAULT_HEIGHT);
        mOvalVerticalRadius = DisplayUtils.dp2px(context, DEFAULT_OVAL_HEIGHT);
