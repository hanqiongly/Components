package com.jack.animator.loading.render.animal;
...
public class GhostsEyeLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mEyeEdgeWidth = DisplayUtils.dp2px(context, DEFAULT_EYE_EDGE_WIDTH);

        mEyeInterval = DisplayUtils.dp2px(context, DEFAULT_EYE_CIRCLE_INTERVAL);
        mEyeBallOffsetY = DisplayUtils.dp2px(context, DEFAULT_EYE_BALL_OFFSET_Y);
        mEyeCircleRadius = DisplayUtils.dp2px(context, DEFAULT_EYE_CIRCLE_RADIUS);
        mMaxEyeJumptDistance = DisplayUtils.dp2px(context, DEFAULT_MAX_EYE_JUMP_DISTANCE);
        mAboveRadianEyeOffsetX = DisplayUtils.dp2px(context, DEFAULT_ABOVE_RADIAN_EYE_CIRCLE_OFFSET);

        mEyeBallWidth = DisplayUtils.dp2px(context, DEFAULT_EYE_BALL_WIDTH);
        mEyeBallHeight = DisplayUtils.dp2px(context, DEFAULT_EYE_BALL_HEIGHT);
