package com.jack.animator.loading.render.shapechange;
...
public class CircleBroodLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mMaxMotherOvalSize = DisplayUtils.dp2px(context, MAX_MATHER_OVAL_SIZE);
        mBasicChildOvalRadius = DisplayUtils.dp2px(context, MIN_CHILD_OVAL_RADIUS);
