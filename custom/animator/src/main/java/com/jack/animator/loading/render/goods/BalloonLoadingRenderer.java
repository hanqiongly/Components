package com.jack.animator.loading.render.goods;
...
public class BalloonLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        mTextSize = DisplayUtils.dp2px(context, DEFAULT_TEXT_SIZE);

        mWidth = DisplayUtils.dp2px(context, DEFAULT_WIDTH);
        mHeight = DisplayUtils.dp2px(context, DEFAULT_HEIGHT);
        mStrokeWidth = DisplayUtils.dp2px(context, DEFAULT_STROKE_WIDTH);

        mGasTubeWidth = DisplayUtils.dp2px(context, DEFAULT_GAS_TUBE_WIDTH);
        mGasTubeHeight = DisplayUtils.dp2px(context, DEFAULT_GAS_TUBE_HEIGHT);
        mCannulaWidth = DisplayUtils.dp2px(context, DEFAULT_CANNULA_WIDTH);
        mCannulaHeight = DisplayUtils.dp2px(context, DEFAULT_CANNULA_HEIGHT);
        mCannulaOffsetY = DisplayUtils.dp2px(context, DEFAULT_CANNULA_OFFSET_Y);
        mCannulaMaxOffsetY = DisplayUtils.dp2px(context, DEFAULT_CANNULA_MAX_OFFSET_Y);
        mPipeBodyWidth = DisplayUtils.dp2px(context, DEFAULT_PIPE_BODY_WIDTH);
        mPipeBodyHeight = DisplayUtils.dp2px(context, DEFAULT_PIPE_BODY_HEIGHT);
        mBalloonWidth = DisplayUtils.dp2px(context, DEFAULT_BALLOON_WIDTH);
        mBalloonHeight = DisplayUtils.dp2px(context, DEFAULT_BALLOON_HEIGHT);
        mRectCornerRadius = DisplayUtils.dp2px(context, DEFAULT_RECT_CORNER_RADIUS);
