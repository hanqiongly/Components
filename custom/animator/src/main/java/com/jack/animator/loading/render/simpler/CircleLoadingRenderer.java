package com.jack.animator.loading.render.simpler;
...
public class CircleLoadingRenderer {
    ...
    private CircleLoadingRenderer(Context context) {
        init(context);
        setupPaint();
    ...
    public static class Builder {
        ...
        public CircleLoadingRenderer build() {
            CircleLoadingRenderer loadingRenderer = new CircleLoadingRenderer(mContext);
