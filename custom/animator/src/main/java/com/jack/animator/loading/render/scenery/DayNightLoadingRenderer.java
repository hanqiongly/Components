package com.jack.animator.loading.render.scenery;
...
public class DayNightLoadingRenderer extends LoadingRenderer {
    ...
    private void init(Context context) {
        ...
        mStarRadius = DisplayUtils.dp2px(context, DEFAULT_STAR_RADIUS);
        mSun$MoonRadius = DisplayUtils.dp2px(context, DEFAULT_SUN$MOON_RADIUS);
        ...
        mSunRayStartCoordinateY = mInitSun$MoonCoordinateY - mMaxSun$MoonRiseDistance //the center
                ...
                - DisplayUtils.dp2px(context, DEFAULT_SUN_RAY_OFFSET); //sub the interval between the sun and the sun ray

        //add strokeWidth * 2.0f because the stroke cap is Paint.Cap.ROUND
        mSunRayEndCoordinateY = mSunRayStartCoordinateY - DisplayUtils.dp2px(context, DEFAULT_SUN_RAY_LENGTH)
                + mStrokeWidth;
