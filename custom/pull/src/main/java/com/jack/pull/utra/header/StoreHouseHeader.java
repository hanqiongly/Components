package com.jack.pull.utra.header;
...
public class StoreHouseHeader extends View implements PtrUIHandler {
    ...
    private void initView() {
        mLineWidth = DisplayUtils.dp2px(getContext(), 1);
        mDropHeight = DisplayUtils.dp2px(getContext(), 40);
        mHorizontalRandomness = DisplayUtils.getScreenWidth(getContext()) / 2;
    }
    ...
    private int getTopOffset() {
        return getPaddingTop() + DisplayUtils.dp2px(getContext(), 10);
    }

    private int getBottomOffset() {
        return getPaddingBottom() + DisplayUtils.dp2px(getContext(), 10);
    }
    ...
    public void initWithPointList(ArrayList<float[]> pointList) {
        ...
        for (int i = 0; i < pointList.size(); i++) {
            ...
            PointF startPoint = new PointF(DisplayUtils.dp2px(getContext(), line[0]) * mScale, DisplayUtils.dp2px(getContext(), line[1]) * mScale);
            PointF endPoint = new PointF(DisplayUtils.dp2px(getContext(), line[2]) * mScale, DisplayUtils.dp2px(getContext(), line[3]) * mScale);
