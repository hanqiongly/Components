...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        final int shadowYOffset = DisplayUtils.dp2px(mParent.getContext(), Y_OFFSET);
        final int shadowXOffset = DisplayUtils.dp2px(mParent.getContext(), X_OFFSET);
        int mShadowRadius = DisplayUtils.dp2px(mParent.getContext(), SHADOW_RADIUS);
