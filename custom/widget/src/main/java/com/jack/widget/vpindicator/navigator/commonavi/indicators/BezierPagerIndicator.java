package com.jack.widget.vpindicator.navigator.commonavi.indicators;
...
import com.jack.widget.vpindicator.navigator.commonavi.holder.ArgbEvaluatorHolder;
import com.jack.widget.vpindicator.navigator.commonavi.position.PositionData;
...
public class BezierPagerIndicator extends View implements IPagerIndicator {
    ...
    private void init(Context context) {
        ...
        mMaxCircleRadius = DisplayUtils.dp2px(context, 3.5f);
        mMinCircleRadius = DisplayUtils.dp2px(context, 2);
        mYOffset = DisplayUtils.dp2px(context, 1.5f);
    }
