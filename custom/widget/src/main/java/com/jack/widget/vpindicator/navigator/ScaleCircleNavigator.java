package com.jack.widget.vpindicator.navigator;
...
public class ScaleCircleNavigator extends View implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init(Context context) {
        ...
        mMinRadius = DisplayUtils.dp2px(context, 3);
        mMaxRadius = DisplayUtils.dp2px(context, 5);
        mCircleSpacing = DisplayUtils.dp2px(context, 8);
